 ...
 ************************************************************************************************************/
                ...
                if (db != null) {
                    ...
                    if (c.moveToFirst()) {
                        ...
                        do {
                            mes[i] = c.getString(0);
                            if (mes[i] == editMesPic.getText().toString()) {
                                b = 1;
                            }
                            i++;
                        } while (c.moveToNext());
      ...
      ******************************************************************************************************/
                ...
                if (db != null) {
                    ...
                    if (c.moveToFirst()) {
                        ...
                        do {
                            mes[i] = c.getString(0);
                            //                   if (mes[i] == Integer.parseInt(editMesPic.getText().toString())) {
                            if (mes[i] == (editMesPic.getText().toString())) {
                                b = 1;
                            }
                            i++;
